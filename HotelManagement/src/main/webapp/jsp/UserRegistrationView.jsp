<%@page import="in.co.hotel.mgt.sys.controller.UserRegistrationCtl"%>
				...
				<div class="row">
					<div class="col">
						<div class="home_content text-center">
							<div class="home_title"><h1>User Registration</h1></div>
						</div>
					</div>
				</div>
			</div>
...
<main class="login-form">
    <div class="cotainer">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">User Registration
              ...
              <b><font color="Green"> <%=ServletUtility.getSuccessMessage(request)%>
                    ...
                    <div class="card-body">
                        <form action="<%=HMSView.USER_REGISTRATION_CTL%>" method="post">
              ...
              <input type="hidden" name="modifiedDatetime" value="<%=DataUtility.getTimestamp(bean.getModifiedDatetime())%>">
                        ...
                        color="red"> <%=ServletUtility.getErrorMessage("password", request)%></font>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="password" id="password" class="form-control" name="confirmPassword" value="<%=DataUtility.getStringData(bean.getConfirmPassword()) %>">
                               <font
                        color="red"> <%=ServletUtility.getErrorMessage("confirmPassword", request)%></font>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" id="email_address" class="form-control" name="mobile" value="<%=DataUtility.getStringData(bean.getMobileNo())%>">
                            ...
                            <div class="col-md-6 offset-md-4">
                                <input type="submit" name="operation" class="btn btn-primary" value="<%=UserRegistrationCtl.OP_SIGN_UP%>">
                                <input type="submit" name="operation" class="btn btn-primary" value="<%=UserRegistrationCtl.OP_RESET%>">
                            </div>
