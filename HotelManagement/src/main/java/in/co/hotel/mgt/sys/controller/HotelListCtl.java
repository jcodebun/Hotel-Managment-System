...
/**
 * Servlet implementation class HotelListCtl
 */
...
public class HotelListCtl extends BaseCtl {
	...
	protected BaseBean populateBean(HttpServletRequest request) {
		log.debug("HotelListCtl populateBean method start");
		HotelBean bean = new HotelBean();
		bean.setName(DataUtility.getString(request.getParameter("name")));
		bean.setCity(DataUtility.getString(request.getParameter("city")));
		log.debug("HotelListCtl populateBean method end");
		return bean;
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		log.debug("HotelListCtl doGet method start");
		List list = null;
		int pageNo = 1;
		...
		log.debug("HotelListCtl doGet method end");
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		log.debug("HotelListCtl doPost method start");
		List list = null;
		...
		log.debug("HotelListCtl doPost method end");
	}

	@Override
	protected String getView() {
		// TODO Auto-generated method stub
		return HMSView.HOTEL_LIST_VIEW;
	}
