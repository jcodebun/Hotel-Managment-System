...
/**
 * Servlet implementation class BookHotelListCtl
 */
@WebServlet(name = "BookHotelListCtl", urlPatterns = { "/ctl/BookHotelListCtl" })
public class BookHotelListCtl extends BaseCtl {
	private static final long serialVersionUID = 1L;
       
	private static Logger log = Logger.getLogger(BookHotelListCtl.class);
	...
	protected BaseBean populateBean(HttpServletRequest request) {
		log.debug("BookHotelListCtl populateBean method start");
		BookHotelBean bean = new BookHotelBean();
		bean.setHotelName(DataUtility.getString(request.getParameter("hName")));
		bean.setUserName(DataUtility.getString(request.getParameter("name")));
		log.debug("BookHotelListCtl populateBean method end");
		return bean;
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		log.debug("BookHotelListCtl doGet method start");
		List list = null;
		int pageNo = 1;
		...
		log.debug("BookHotelListCtl doGet method end");
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		log.debug("BookHotelListCtl doPost method start");
		List list = null;
		...
		if (OP_SEARCH.equalsIgnoreCase(op) || OP_NEXT.equalsIgnoreCase(op) || OP_PREVIOUS.equalsIgnoreCase(op)) {
			...
			BookHotelBean deletebean = new BookHotelBean();
				for (String id : ids) {
		...
		log.debug("BookHotelListCtl doPost method end");
	}

	@Override
	protected String getView() {
		// TODO Auto-generated method stub
		return HMSView.BOOK_HOTEL_LIST_VIEW;
	}
